...
namespace BlendModes
{
    ...
    {
        private bool showEditor, showMaterialParams, showMaskMode, showMaskBehaviour, showFramebufferInfo, showUnityProWarning, showOverlayParams;
        ...
        private GUIContent overlayTextureContent = new GUIContent("Overlay Texture", "Overlay texture to blend with the object's texture.");
        private GUIContent overlayTextureOffsetContent = new GUIContent("Overlay Texture Offset", "UV offset of the overlay texture used in overlay render mode.");
        private GUIContent overlayTextureScaleContent = new GUIContent("Overlay Texture Scale", "UV scale of the overlay texture used in overlay render mode.");
        private GUIContent overlayColorContent = new GUIContent("Overlay Color", "Overlay color to blend with the object.");
        ...
        private SerializedProperty overlayTextureScale;
        ...
        private void OnEnable ()
        {
            ...
            overlayTextureScale = serializedObject.FindProperty("_overlayTextureScale");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (Event.current.type == EventType.Layout)
            {
                ...
                showOverlayParams = blendEffect.RenderMode == RenderMode.Overlay;
            }
            ...
            if (showEditor)
            {
                ...
                if (showOverlayParams)
                {
                    EditorGUILayout.PropertyField(overlayTexture, overlayTextureContent);
                    EditorGUILayout.PropertyField(overlayTextureScale, overlayTextureScaleContent);
                    EditorGUILayout.PropertyField(overlayTextureOffset, overlayTextureOffsetContent);
                    EditorGUILayout.PropertyField(overlayColor, overlayColorContent);
                }
